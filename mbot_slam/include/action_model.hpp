...
private:
    ...
    double k1_{0.005};          // rotational noise coefficient
    double k2_{0.001};          // translational noise coefficient
    double k3_{0.0005};           // rotational noise coefficient when translating
    double k4_{0};  
